        ...
        <tbody>
            <?php while ($row = mysqli_fetch_assoc($result)){ ?>
                <tr>
                    ...
                    <td> <a href="changeBlock.php?id=<?php echo $row['BlockId']; ?>" style="background-color: greenyellow">Change</a><a href="deleteBlock.php?id=<?php echo $row['BlockId']; ?>" style="background-color: red;">Delete</a></td>
                </tr>
            <?php } ?>
        </tbody>
    </table>
