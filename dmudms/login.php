...
<body>
    ...
    <form method="post" action="login.php">
        ...
        <div> 
            <input type="submit" name="login" value="Login As Employee "><br/>
            <input type="submit" name="loginS" value="Login As a Student">
            <input type="reset" name="clear" value="Clear">
            <a href="forgot.php" style="background-color: lightblue; color: blue; padding: 5px;"> Forgot password?</a>
        </div>
    </form>
</body>
