...
// Check if the user ID is provided as a query parameter
    ...
    $query = "SELECT * FROM Accounts WHERE UserName = '$userId'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $updateQuery = "UPDATE Accounts SET password = '$newPassword' WHERE UserName = '$userId'";
        ...
        <body>
            ...
            <form method="POST" action="">
                ...
                <input type="text" id="newUserName" name="newUserName" value="<?php echo $user['UserName']; ?>" readonly>  <br><br>
                <label for="newUType">User Type:</label>
                <input type="text" id="newUType" name="newUType" value="<?php echo $user['U_Type']; ?>" readonly>         <br><br>
                 <label for="newPassword">Password:</label>
                <input type="text" id="newPassword" name="newPassword" required pattern="[a-z0-9A-Z_].{5,}" value="<?php echo $user['password']; ?>">   <br><br>
